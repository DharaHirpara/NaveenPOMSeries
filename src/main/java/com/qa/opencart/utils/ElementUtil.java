...
public class ElementUtil {
	...
	public void doSendKeys(By locator, String value) {
		...
		getElement(locator).clear();//enter value macBook and search it and clear again search imac
	...
	@Step("clicking on element using locator: {0}")//0 index means 1st element
	...
	@Step("checking element {0} is displayed...")//0 index means 1st element-->(By locator)
	 ...
	 * @return
	 */
	@Step("waiting for element using locator : {0} within timeout {1}")//locator : {0} within timeout {1} means -->
	//there is 2 para 1st is on 0 index and 2nd is on 1 index (By locator, int timeOut)
